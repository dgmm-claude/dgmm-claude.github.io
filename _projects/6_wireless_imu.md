...
基于 ESP32-C3 + ICM-20948 的无线九轴 IMU 姿态追踪节点，固件通过 WiFi 将 VQF 融合后的四元数实时传输至上位机。它是 [宇树 G1 上肢 IMU 遥操系统](/projects/1_unitree_g1_teleop/) **实际采用的感知层**——已替代原先的 WT901C485 成品 IMU 模块，独立完成并同时开源。**完整硬件设计、固件与上位机已开源。**
